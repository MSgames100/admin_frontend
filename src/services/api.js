...
const API_URL = 'https://api.msgames.com/api';
...
export const rateVersionsApi = {
  getAll: (simulationId) => apiRequest(`/rate-versions/?simulationId=${simulationId}`),
  getLatest: (simulationId) => apiRequest(`/rate-versions/latest/${simulationId}`),
...
export const professorsApi = {
  getAll: (instituteId) => apiRequest(`/professors/?instituteId=${instituteId || ''}`),
